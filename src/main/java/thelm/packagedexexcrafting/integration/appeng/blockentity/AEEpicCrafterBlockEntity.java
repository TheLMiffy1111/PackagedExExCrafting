package thelm.packagedexexcrafting.integration.appeng.blockentity;
...
public class AEEpicCrafterBlockEntity extends EpicCrafterBlockEntity implements IInWorldGridNodeHost, IGridNodeListener<AEEpicCrafterBlockEntity>, IActionHost {

	public boolean firstTick = true;
	public IActionSource source;
	public IManagedGridNode gridNode;

	public AEEpicCrafterBlockEntity(BlockPos pos, BlockState state) {
		super(pos, state);
	...
	@Override
	public void onSaveChanges(AEEpicCrafterBlockEntity nodeOwner, IGridNode node) {
		setChanged();
	}
	...
	public IManagedGridNode getMainNode() {
		if(gridNode == null) {
			...
			gridNode.setVisualRepresentation(EpicCrafterBlock.INSTANCE);
